                        ...
                        <td colspan="7">
                            ...
                            <div class="wcmp-order-actions  wcmp-order-data-row-toggle">
                                ...
                                <?php if( $order->get_status( 'edit' ) != 'cancelled' ) : ?>
                                    <button type="button" class="button refund-items btn btn-default"><?php esc_html_e('Refund Item', 'woocommerce'); ?></button>
                                    <button type="button" class="button cancel-order btn btn-default"><?php esc_html_e('Cancel Order', 'woocommerce'); ?></button>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php
